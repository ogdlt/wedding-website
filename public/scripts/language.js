(function () {
  ...
  var translations = {
    es: {
      ...
      "Begin in the heart of Valencia at the City Hall square, framed by elegant architecture, fountains and some of the city's most beautiful historic buildings.": "Empieza en el corazón de Valencia, en la Plaza del Ayuntamiento, rodeada de arquitectura elegante, fuentes y algunos de los edificios históricos más bonitos de la ciudad.",
      "Wander through the beautiful local market, with its fresh fish, Valencian produce, colourful stalls and remarkable modernist architecture. While you are there, try a fresh horchata with fartons, a classic Valencian treat.": "Recorre este precioso mercado local, con pescado fresco, productos valencianos, puestos llenos de color y una extraordinaria arquitectura modernista. Ya que estás allí, prueba una horchata fresca con fartons, todo un clásico valenciano.",
      "Step inside Valencia's historic Silk Exchange, a Gothic landmark just across from the market and one of the city's most treasured buildings.": "Entra en la histórica Lonja de la Seda, un monumento gótico frente al mercado y uno de los edificios más emblemáticos de la ciudad.",
    ...
    fr: {
      ...
      "Begin in the heart of Valencia at the City Hall square, framed by elegant architecture, fountains and some of the city's most beautiful historic buildings.": "Commencez au cœur de Valence, sur la place de l’Hôtel de Ville, entourée d’une architecture élégante, de fontaines et de quelques-uns des plus beaux bâtiments historiques de la ville.",
      "Wander through the beautiful local market, with its fresh fish, Valencian produce, colourful stalls and remarkable modernist architecture. While you are there, try a fresh horchata with fartons, a classic Valencian treat.": "Parcourez ce magnifique marché local avec ses poissons frais, ses produits valenciens, ses étals colorés et sa remarquable architecture moderniste. Profitez-en pour goûter une horchata fraîche accompagnée de fartons, une spécialité valencienne.",
      "Step inside Valencia's historic Silk Exchange, a Gothic landmark just across from the market and one of the city's most treasured buildings.": "Entrez dans l’ancienne Bourse de la soie, un joyau gothique situé face au marché et l’un des édifices les plus précieux de la ville.",
    ...
    fa: {
      ...
      "Begin in the heart of Valencia at the City Hall square, framed by elegant architecture, fountains and some of the city's most beautiful historic buildings.": "از قلب والنسیا، میدان شهرداری، آغاز کنید؛ میدانی با معماری باشکوه، فواره‌ها و برخی از زیباترین ساختمان‌های تاریخی شهر.",
      "Wander through the beautiful local market, with its fresh fish, Valencian produce, colourful stalls and remarkable modernist architecture. While you are there, try a fresh horchata with fartons, a classic Valencian treat.": "در این بازار زیبای محلی میان ماهی تازه، محصولات والنسیا، غرفه‌های رنگارنگ و معماری مدرنیستی چشمگیر قدم بزنید. همان‌جا یک هورچاتای تازه با فارتون، خوراکی کلاسیک والنسیا، امتحان کنید.",
      "Step inside Valencia's historic Silk Exchange, a Gothic landmark just across from the market and one of the city's most treasured buildings.": "از بازار تاریخی ابریشم والنسیا دیدن کنید؛ بنایی گوتیک روبه‌روی بازار و یکی از ارزشمندترین ساختمان‌های شهر.",
